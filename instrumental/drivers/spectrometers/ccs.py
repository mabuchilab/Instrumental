...
def _instrument(params):
    """ Possible params include 'spec_usb_address', 'spec_serial_number',
    'spec_model'.
    """
    print("Checking for CCS spectromer...")
    if 'spec_usb_address' in params:
        return get_spectrometer(address=params['spec_usb_address'])
    elif 'spec_serial_number' in params:
        return get_spectrometer(serial=params['spec_serial_number'])
    elif 'spec_model' in params:
        return get_spectrometer(model=params['spec_model'])
